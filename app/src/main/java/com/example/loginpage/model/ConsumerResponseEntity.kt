...
@Entity(tableName = "consumer_response")
data class ConsumerResponseEntity(
    @PrimaryKey(autoGenerate = true)
    val localId: Int = 0,  // Room needs a primary key, since KNO might not be unique or nullable
